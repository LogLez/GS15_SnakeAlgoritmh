...
def encrypt(plainText, userKey):
    ...
    print("plainText\n- ", hex.bitstring2hexstring(plainText), "\n")
    print("userKey\n- ", hex.bitstring2hexstring(userKey), "\n")
...
def decrypt(cipherText, userKey):
    ...
    print("plainText\n- ", hex.bitstring2hexstring(cipherText), "\n")
    print("userKey\n- ", hex.bitstring2hexstring(userKey), "\n")
    K, KHat = makeSubkeys(userKey)
...
help = """
    ...
    serpref -e -k 123456789abcdef  -p "47533135206973206772656174"
        Encrypt the plaintext "Hello World" with the given key.

    serpref -d -k 123456789abcdef  -c "47533135206973206772656174"
        Decrypt the ciphertext "47533135206973206772656174" with the given key.
"""
...
def main():
    optList, rest = getopt.getopt(sys.argv[1:], "edh:k:p:c:")
